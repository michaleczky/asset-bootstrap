...
public class AssetFactoryCFIT extends BaseFactoryIT {
	...
	public void testMarshal() {
		...
		com.ge.predix.entity.asset.AssetTag am = (com.ge.predix.entity.asset.AssetTag) this.jsonMapper.fromJson(json, com.ge.predix.entity.model.Typed.class);
	...
	public void testGetAssetsWithSameClassification(List<Header> headers) {
		List<Asset> list = this.assetFactory.getAssetsByFilter(null, "classificationUri", "/classification/GasTurbineTest", //$NON-NLS-1$//$NON-NLS-2$
				headers);
