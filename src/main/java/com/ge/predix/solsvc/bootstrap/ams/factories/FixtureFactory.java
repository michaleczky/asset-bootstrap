        ...
        implements RestConstants
{
    ...
    public <T> CloseableHttpResponse create(List<T> objects, List<Header> headers)
    {
        ...
        CloseableHttpResponse response = this.restClient.post(url, body, localheaders, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
        return response;
    }
    ...
    public <T> CloseableHttpResponse createCustomModels(List<T> objects, List<Header> headers)
    {
        ...
        CloseableHttpResponse response = this.restClient.post(url, json, localheaders, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
    ...
    public <T> CloseableHttpResponse createCustomModels(List<T> objects, String jsonString, List<Header> headers)
    {
        List<Header> localheaders = ensureDefaultHeadersArePresent(headers);
        String url = this.config.createCustomModelUrlForPost(objects.get(0));
        CloseableHttpResponse response = this.restClient.post(url, jsonString, headers, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
        return response;
    }
    ...
    public <T> CloseableHttpResponse updateCustomModel(T object, List<Header> headers)
    {
        ...
        log.debug("url=" + url + " create json=" + json);
        CloseableHttpResponse response = this.restClient.put(url, json, localheaders, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
    ...
    public CloseableHttpResponse get(Class<?> clazz, List<Header> headers)
    {
        ...
        return this.restClient.get(url, headers, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
    }
    ...
    public CloseableHttpResponse getCustomModels(String filterUri, String model,  List<Header> headers)
    {
        ...
        if ( !assetUri.endsWith("/") && !filterUri.startsWith("/") )
            ...
            assetUri += filterUri;
        return this.restClient.get(assetUri, localHeaders, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
    }
    ...
    public CloseableHttpResponse delete(Class<?> clazz, String pathParam, List<Header> headers)
    {
        ...
        return this.restClient.delete(url, headers, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
    }
    ...
    {
        return this.restClient.delete(uri, headers, this.assetRestConfig.getAssetConnectionTimeout(), this.assetRestConfig.getAssetSocketTimeout());
    }
